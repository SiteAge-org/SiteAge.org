...
export function renderCertificateSvg(data: BadgeData): string {
  ...
  const verifiedBlock = isVerified
    ? `<rect x="420" y="308" width="360" height="30" rx="4" fill="#c8a44e" opacity="0.15"/>
       <text x="600" y="328" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="13" font-weight="600" fill="#a8872e" letter-spacing="3" text-decoration="none">
  ...
  <!-- Title -->
  <text x="600" y="120" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="13" font-weight="600" fill="#a8872e" letter-spacing="5">CERTIFICATE OF WEBSITE LONGEVITY</text>

  <!-- Ornamental divider -->
  <line x1="450" y1="145" x2="560" y2="145" stroke="#c8a44e" stroke-width="0.8" opacity="0.6"/>
  <text x="600" y="150" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="14" fill="#c8a44e" opacity="0.8">&#x25C6;</text>
  <line x1="640" y1="145" x2="750" y2="145" stroke="#c8a44e" stroke-width="0.8" opacity="0.6"/>

  <!-- Domain name -->
  <text x="600" y="220" text-anchor="middle" font-family="'DM Serif Display'" font-size="48" fill="#1a1d2e">${domain}</text>

  <!-- Verification badge -->
  ${verifiedBlock}

  <!-- Online Since label -->
  <text x="600" y="${310 + verifiedYOffset}" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="13" fill="#6b7094" letter-spacing="3">${isVerified ? "ESTABLISHED" : "ONLINE SINCE"}</text>

  <!-- Year (large) -->
  <text x="600" y="${390 + verifiedYOffset}" text-anchor="middle" font-family="'DM Serif Display'" font-size="80" fill="#1a1d2e">${year}</text>

  <!-- Full date -->
  <text x="600" y="${420 + verifiedYOffset}" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="15" fill="#6b7094">${fullDate}</text>

  <!-- Divider -->
  <line x1="470" y1="${450 + verifiedYOffset}" x2="730" y2="${450 + verifiedYOffset}" stroke="#e8e0d0" stroke-width="0.8"/>

  <!-- Age text -->
  <text x="600" y="${478 + verifiedYOffset}" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="16" fill="#1a1d2e" font-weight="500">${ageText}</text>

  <!-- Brand footer -->
  <text x="600" y="${560 + verifiedYOffset > 580 ? 580 : 560 + verifiedYOffset}" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="12" fill="#6b7094" opacity="0.7">siteage.org &#xB7; Powered by Wayback Machine</text>
</svg>`;
}
...
function renderUnknownSvg(domain: string): string {
  ...
  <!-- Title -->
  <text x="600" y="180" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="13" font-weight="600" fill="#a8872e" letter-spacing="5">WEBSITE AGE CERTIFICATE</text>

  <!-- Ornamental divider -->
  <line x1="450" y1="205" x2="560" y2="205" stroke="#c8a44e" stroke-width="0.8" opacity="0.6"/>
  <text x="600" y="210" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="14" fill="#c8a44e" opacity="0.8">&#x25C6;</text>
  ...
  <!-- Pending text -->
  <text x="600" y="370" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="20" fill="#6b7094">Age pending...</text>

  <!-- Brand footer -->
  <text x="600" y="530" text-anchor="middle" font-family="'IBM Plex Sans'" font-size="12" fill="#6b7094" opacity="0.7">siteage.org &#xB7; Powered by Wayback Machine</text>
</svg>`;
}
